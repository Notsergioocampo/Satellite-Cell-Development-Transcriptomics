...
```
## Warning: The following result files are missing; corresponding figures will show placeholder panels:
...
Table: Dataset characteristics and experimental design.
...
<img src="figure/volcano-plot-1.png" alt="Volcano plot for P12 vs P1 differential expression."  />
<p class="caption">Volcano plot for P12 vs P1 differential expression.</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="figure/grn-plot-1.png" alt="Gene regulatory network (GRN) among key regulators and targets."  />
<p class="caption">Gene regulatory network (GRN) among key regulators and targets.</p>
</div>
...
<div class="figure" style="text-align: center">
<img src="figure/umap-embedding-1.png" alt="UMAP embedding of samples based on transcriptomic profiles."  />
<p class="caption">UMAP embedding of samples based on transcriptomic profiles.</p>
</div>
